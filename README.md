...
[![Feature Requests](https://img.shields.io/github/issues/YashTechnologyPvtLtd/vscode/feature-request.svg)](https://github.com/YashTechnologyPvtLtd/vscode/issues?q=is%3Aopen+is%3Aissue+label%3Afeature-request+sort%3Areactions-%2B1-desc)
[![Bugs](https://img.shields.io/github/issues/YashTechnologyPvtLtd/vscode/bug.svg)](https://github.com/YashTechnologyPvtLtd/vscode/issues?utf8=✓&q=is%3Aissue+is%3Aopen+label%3Abug)
[![Gitter](https://img.shields.io/badge/chat-on%20gitter-yellow.svg)](https://gitter.im/YashTechnologyPvtLtd/vscode)
...
- [Submit bugs and feature requests](https://github.com/YashTechnologyPvtLtd/vscode/issues), and help us verify as they are checked in
- Review [source code changes](https://github.com/YashTechnologyPvtLtd/vscode/pulls)
- Review the [documentation](https://github.com/YashTechnologyPvtLtd/vscode-docs) and make pull requests for anything from typos to additional and new content

If you are interested in fixing issues and contributing directly to the code base,
please see the document [How to Contribute](https://github.com/YashTechnologyPvtLtd/vscode/wiki/How-to-Contribute), which covers the following:

- [How to build and run from source](https://github.com/YashTechnologyPvtLtd/vscode/wiki/How-to-Contribute)
- [The development workflow, including debugging and running tests](https://github.com/YashTechnologyPvtLtd/vscode/wiki/How-to-Contribute#debugging)
- [Coding guidelines](https://github.com/YashTechnologyPvtLtd/vscode/wiki/Coding-Guidelines)
- [Submitting pull requests](https://github.com/YashTechnologyPvtLtd/vscode/wiki/How-to-Contribute#pull-requests)
- [Finding an issue to work on](https://github.com/YashTechnologyPvtLtd/vscode/wiki/How-to-Contribute#where-to-contribute)
...
- Upvote [popular feature requests](https://github.com/YashTechnologyPvtLtd/vscode/issues?q=is%3Aopen+is%3Aissue+label%3Afeature-request+sort%3Areactions-%2B1-desc)
- [File an issue](https://github.com/YashTechnologyPvtLtd/vscode/issues)
- Connect with the extension author community on [GitHub Discussions](https://github.com/YashTechnologyPvtLtd/vscode-discussions/discussions) or [Slack](https://aka.ms/vscode-dev-community)
...
- For [Dev Containers](https://aka.ms/vscode-remote/download/containers), use the **Dev Containers: Clone Repository in Container Volume...** command which creates a Docker volume for better disk I/O on macOS and Windows.
  ...
  - If you already have VS Code and Docker installed, you can also click [here](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/YashTechnologyPvtLtd/vscode) to get started. This will cause VS Code to automatically install the Dev Containers extension if needed, clone the source code into a container volume, and spin up a dev container for use.
...
This project has adopted the [YashTechnologyPvtLtd Open Source Code of Conduct](https://opensource.YashTechnologyPvtLtd.com/codeofconduct/). For more information see the [Code of Conduct FAQ](https://opensource.YashTechnologyPvtLtd.com/codeofconduct/faq/) or contact [opencode@YashTechnologyPvtLtd.com](mailto:opencode@YashTechnologyPvtLtd.com) with any additional questions or comments.
