...
function updateSessionsList(sessions) {
    ...
    sessionsList.innerHTML = sessions.map(session => {
        const deleteButton = session.isOwner ? `<button class="btn btn-sm btn-danger" onclick="deleteSession('${session.id}')">Delete</button>` : '';
        return `
        ...
        <div class="session-details">
            ...
            <div class="session-detail-participants">
                ...
                <div class="participants-list">
                    ${session.participantsList ? session.participantsList.map(p => `
